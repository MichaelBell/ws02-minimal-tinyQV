...
module tqvp_toivoh_pwl_synth #(parameter BITS=12, BITS_E=13, OCT_BITS=3, DETUNE_EXP_BITS=3, SLOPE_EXP_BITS=4, NUM_CHANNELS=4, NUM_GPIO=8) (
...
`endif
	...
	assign uo_out = {NUM_GPIO/2{pwm_outs}};
