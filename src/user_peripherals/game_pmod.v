...
module tqvp_game_pmod #( parameter NUM_GPIO = 8 )(
    input         clk,
    input         rst_n,

    input  [NUM_GPIO-1:0]  ui_in,        // The input PMOD, always available
    ...
    wire _unused = &{data_read_n, data_in[31:1], ui_in[2:0], 1'b0};
